package com.educative.patterns.chapter3.fastslowpointer;

class FindDuplicateUsingTwoPointers {
	...
	public static void main(String[] args) {
		...
		System.out.println(FindDuplicateUsingTwoPointers.findDuplicate(new int[] { 2, 4, 1, 2, 2 }));
	}
}