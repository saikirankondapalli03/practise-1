...
class MinimumWindowSubstring {
	...
	public static void main(String[] args) {
		System.out.println(MinimumWindowSubstring.findSubstring("adbc1cabc", "abc"));
		System.out.println(MinimumWindowSubstring.findSubstring("abcddec", "abc"));
		System.out.println(MinimumWindowSubstring.findSubstring("zwewabdabca", "abc"));
