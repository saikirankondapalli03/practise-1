package com.educative.patterns.chapter9;
...
class SlidingWindowMedian {
	...
	public static void main(String[] args) {
		...
		//s.maxHeap.add(1);
		//s.maxHeap.add(5);
		double[] result = s.findSlidingWindowMedian(new int[] { 1, 2, -1, 3, 5 }, 2);
		...
		result = s.findSlidingWindowMedian(new int[] { 1, 2, -1, 3, 5 }, 3);
		System.out.print("Sliding window medians are: ");
		for (double num : result)
			System.out.print(num + " ");
	}
