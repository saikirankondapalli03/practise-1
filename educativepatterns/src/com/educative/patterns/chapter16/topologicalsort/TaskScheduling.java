package com.educative.patterns.chapter16.topologicalsort;
...
class TaskScheduling {
	public static boolean isSchedulingPossible(int tasks, int[][] prerequisites) {
		...
		// b. Build the graph while setting inDegree
...
/*		boolean result = TaskScheduling.isSchedulingPossible(3, new int[][] { new int[] { 0, 1 }, new int[] { 1, 2 } });
		...
		System.out.println("Tasks execution possible: " + result);
*/
		boolean result = TaskScheduling.isSchedulingPossible(7, new int[][] { new int[] {5,3 }, new int[] {5,4 },
				new int[] {6, 4 }, new int[] { 6,2 }, new int[] { 3,0}, new int[] { 3, 1 }, new int[] { 3, 2 }, new int[] { 4,1 } });
		System.out.println("Tasks execution possible: " + result);
	}
}