package com.patterns.binarysearch.pattern3rotatedarrays;
...
class RotationCountWithDuplicates {
	...
	public static void main(String[] args) {
		System.out.println(RotationCountWithDuplicates.countRotations(new int[] { 3, 3,3,3,3,3,4,4,5,6,7,7, 3,3,3,3,3 }));
	}
}
