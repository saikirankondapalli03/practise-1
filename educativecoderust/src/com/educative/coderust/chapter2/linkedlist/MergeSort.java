...
class MergeSort {
	...
	// It returns head pointers of first and 2nd halves of linked lists in
	// firstSecond
	// Head of 1st half is just the head node of linked list
	public static void splitInHalf(LinkedListNode head, Pair<LinkedListNode, LinkedListNode> firstSecond) {
	...
	public static LinkedListNode mergreSortedLists(LinkedListNode first, LinkedListNode second) {
	...
	public static LinkedListNode mergeSort(LinkedListNode head) {
		...
		Pair<LinkedListNode, LinkedListNode> firstSecond = new Pair<LinkedListNode, LinkedListNode>(null, null);
