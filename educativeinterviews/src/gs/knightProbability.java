...
public class knightProbability {
	...
	public double knightProbability(int N, int K, int r, int c) {
		...
		// prob returns the total paths which stayed inside the board and then we divide
		// it with total number of moves .
	...
	public double prob(int N, int K, int r, int c) {
		...
		// There are total of 8 possible moves and we are traversing all the possible
		// paths.
