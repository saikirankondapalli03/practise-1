...
class CheckPath {
	...
	public static String tracePath(Map<String, String> map) {
		...
		// Create a reverse Map of given map i.e if given map has (N,C) then reverse map
		// will have (C,N) as key value pair
		...
		// After starting point is found, simply trace the complete path from original
		// map.
